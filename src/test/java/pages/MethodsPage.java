...
public class MethodsPage extends BasePage {
    ...
    List <WebElement> selectedLocality;
    ...
    @AndroidFindBy(xpath = "//android.widget.CheckedTextView[@content-desc=\"1\"]")
...
//    public String returnSelectedLocality(int index) {
//        return getTextWithIndex(selectedLocality, index, 10);
//    }
